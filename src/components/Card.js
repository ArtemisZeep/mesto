export default class Card {
  ...
  _setEventListeners = () => {
    ...
    this._elementPhoto.addEventListener('click', () => this._cardPhotoZoom(this.name, this.link));
  ...
  createCard() {
    ...
    this.likeCounterElement =  this._card.querySelector(".element__like-counter");
